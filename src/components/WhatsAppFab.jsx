...
export default function WhatsAppFab() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-40 inline-flex items-center gap-3 bg-[#25D366] text-white rounded-full shadow-2xl shadow-[#25D366]/40 overflow-hidden"
    >
